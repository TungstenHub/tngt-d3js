...
pi = FPoint.int_ab_cd(c,FPoint.add_vector(c, new Vector(1,0)),a,p2),
pe = FPoint.int_ab_cd(p3,FPoint.add_vector(p3, new Vector(1,0)),a,p2),
qi = FPoint.int_ab_cd(c,FPoint.add_vector(c, new Vector(1,0)),b,q3),
qe = FPoint.int_ab_cd(q2,FPoint.add_vector(q2, new Vector(1,0)),b,q3),
