...
smooth_step = function(u) {return u/(2*Math.PI)-Math.atan(50*Math.sin(u)/(Math.cos(u) + 1))/Math.PI-Math.floor((u+Math.PI)/(2*Math.PI))}
...
for (k of Array.from({length: 5}, (x,i) => i)) {
